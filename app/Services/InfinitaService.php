    ...
    private function datosCliente($cliente,$productoId,$adicionales,$solicitudDeLinea,$cuentaNumero){
        ...
        return  (object)[
            "wSolicitud" => (object)[
                ...
                "SolCiuId" => isset($cliente) ? (int)$cliente->ciudad_id : 0,
                "SolBarId" => isset($cliente) ? (int)$cliente->barrio_id : 0,
                "SolDirLat" => isset($cliente) ? $cliente->latitud_direccion : '',
                "SolDirLon" => isset($cliente) ? $cliente->longitud_direccion : '',
                "SolLabDirLat" => isset($cliente) ? $cliente->latitud_empresa : '',
                "SolLabDirLon" => isset($cliente) ? $cliente->longitud_empresa : '',
