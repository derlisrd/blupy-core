...
return [
    ...
    'movimientos'=>[
        'periodo'=>['required', 'regex:/^(0[1-9]|1[0-2])-\d{4}$/'],
    ...
    "auth"=>[
        ...
        "register"=>[
            ...
            'messages'=>[
                ...
                'fotoselfie.required'=>'La foto selfie con ci es requerida.',
    ...
    "solicitudes"=>[
        ...
        "solicitar"=>[
            ...
            'antiguedad_laboral_mes'=>'required|numeric|min:0|max:11',
            'empresa'=>'required',
            ...
            'messages'=>[
                ...
                'antiguedad_laboral_mes.min' => 'Antigüedad en meses debe estar entre 0 y 11.',
                'antiguedad_laboral_mes.max' => 'Antigüedad en meses debe estar entre 0 y 11.',
